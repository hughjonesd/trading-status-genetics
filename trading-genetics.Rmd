...
different polygenic scores in the UK Biobank sample.[^18] We regress
...
order is indeed exogenous to genetics (as @isungset2022birth also find).

[^18]: Polygenic scores were residualized on the first 100 principal
