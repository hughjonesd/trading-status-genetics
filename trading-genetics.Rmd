...
to estimate other parameters." For example, @collado2023estimating
...
factor; @torvik2022modeling estimate partner correlation between "true"
...
generations; while @clark2023inheritance argue for a purely genetic
