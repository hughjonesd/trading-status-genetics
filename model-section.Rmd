...
```{r pic-asymptotic-corr, fig.align = "center", fig.cap = "Long-run squared correlation between genetics $x_1$ and SES $x_2$ (heritability of SES), by weight of genetics in spouse matching ($a$) and strength of direct transmission of SES ($\\theta$). $\\tau$ = 0.95.", dpi = 300, out.width="6in"}
